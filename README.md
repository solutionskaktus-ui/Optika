...
🌐 **Live:** [optikavisage.com](https://optikavisage.com/) *(nakon postavljanja domena)*
...
1. Na GitHubu napravi novi repo, npr. `visage-site` ili `optikavisage.com`
...
1. Kupi domen (preporuka: `optikavisage.com` na RNIDS ili kod registara kao GoDaddy, Loopia)
...
3. U **Settings → Pages → Custom domain** unesi `optikavisage.com`
...
### 1. Adresa stvarne domene (sve linije sa `optikavisage.com`)
...
3. Verifikuj sajt u **Google Search Console** (optikavisage.com)
